        ...
        <div class="container mt-5 ">
                <div class="row mt-5">
                    <div class="col-3 mt-5 pr-3">
                        <h2> <strong>Naava Resort and Retreat </strong></h2>
                        <p><strong>Our hotel is an image of quality and profesionalism combined with hard work and
                    ...
                    <div class="col-3 mt-5 pb-2">
                        ...
                        <ul>
                            <li>example@naava.com</li>
                            <li>+0 320 422 4254</li>
                            <li>Main Str Nepal</li>
                        </ul>
                    </div>
