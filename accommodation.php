...
<div class="container mt-5 ">
    <h2 class="ml-4"> <strong>Best Place <br> Best View.</strong></h2>
        ...
        <div class="row ml-1">
            ...
            <div class="col-3 pl-5 pr-0 pt-2">
                    <h6 class="Header_6"><strong>PREMIUM</strong></h6>
                    <h6><strong>Big Room</strong></h6>
                    <p>Biggest room in our hotel fully equipped with Wi-fi and hot coffee</p>
            </div>
            <div class="col-1 bg-secondary mt-2">
                <i class='fas fa-arrow-circle-right pt-5 ' style='font-size:28px'></i>
            </div>
            <div class="col-2">
            ...
            <div class="col-3 pl-5 pr-0 pt-2">
                    <h6 class="Header_6"><strong>EXPENSIVE</strong></h5>
                    <h6><strong>Expensive Luxury Room</strong></h6>
